...
# was:	add	28, 28, _tmp_27_
	sw	$18, 0($10)
# was:	sw	_size_reg_16_, 0(_arg_reg_18_)
	addi	$17, $20, 4
...
# 	ori	2,_val_reg_17_,0
# 	ori	3,_res_reg_20_,0
	jal	incr
# was:	jal	incr, 2 3
# 	ori	_tmp_reg_26_,2,0
# 	ori	_val_reg_17_,_tmp_reg_26_,0
	addi	$19, $19, 4
# was:	addi	_elem_reg_19_, _elem_reg_19_, 4
	sw	$2, 0($19)
# was:	sw	_val_reg_17_, 0(_elem_reg_19_)
	addi	$17, $17, 4
...
# was:	addi	_i_reg_22_, _i_reg_22_, 1
	j	_loop_beg_23_
_loop_end_24_:
# 	ori	_arr_reg_29_,_letBind_15_,0
	lw	$16, 0($20)
