...
# was:	beq	_divide_R_37_, 0, _IllegalDivision_
	div	$11, $2, $10
...
# was:	ori	_letBind_72_, 28, 0
	sll	$10, $17, 2
# was:	sll	_tmp_97_, _size_in_reg_73_, 2
	addi	$10, $10, 4
...
_loop_end_81_:
	sw	$20, 0($16)
# was:	sw	_size_out_reg_74_, 0(_letBind_72_)
# 	ori	_arg_98_,_letBind_72_,0
	ori	$2, $16, 0
# was:	ori	2, _arg_98_, 0
	jal	write_2darr
