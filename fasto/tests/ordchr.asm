...
# 	ori	_size_reg_9_,_param_n_3_,0
	addi	$11, $11, -1
# was:	addi	_size_reg_9_, _size_reg_9_, -1
	bgez	$11, _safe_lab_10_
...
# 	ori	_mainres_28_,_tmp_66_,0
	ori	$2, $16, 0
# was:	ori	2, _tmp_66_, 0
	jal	putstring
# was:	jal	putstring, 2
	ori	$2, $16, 0
